...
namespace Bugfender.Sdk
{
    ...
    public partial class BugfenderBinding : IBugfenderBinding
    {
        ...
        {
            BugfenderSDK.Bugfender.SetDeviceString(key: key, value: value);
        }

        public void SetDeviceInteger(string key, int value)
        {
            BugfenderSDK.Bugfender.SetDeviceInteger(key: key, value: (ulong)value);
        }

        public void SetDeviceFloat(string key, float value)
        {
            BugfenderSDK.Bugfender.SetDeviceDouble(key: key, value: value);
        }
        ...
        public void Log(int lineNumber, String method, String file, LogLevel logLevel, String tag, String message)
        {
            ...
            BugfenderSDK.Bugfender.Log(lineNumber, method, file, MapLoglLevelToBFLogLevel(logLevel), tag, message);
        }
        ...
        {
            NSUrl url = BugfenderSDK.Bugfender.SendIssueReturningUrl(title, markdown);
            if (url == null)
                return null;
            return new Uri(url.ToString());
        }
        ...
        {
            NSUrl url = BugfenderSDK.Bugfender.SendCrash(title, text);
            if (url == null)
                return null;
            return new Uri(url.ToString());
        }
        ...
        {
            NSUrl url = BugfenderSDK.Bugfender.SendUserFeedbackReturningUrl(subject, message);
            if (url == null)
                return null;
            return new Uri(url.ToString());
        }
        ...
        private static void AppDomainExceptionHandler(object sender, UnhandledExceptionEventArgs unhandledExceptionEventArgs)
        {
            ...
            BugfenderSDK.Bugfender.SendCrash(title, detail);
        }
